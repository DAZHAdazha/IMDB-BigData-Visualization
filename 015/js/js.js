...
function echarts_5() {
  ...
  //  backgroundColor: '#00265f',
    ...
    xAxis: [{
        type: 'category',
      		data: ['A Quiet Place Part II', 'Cruella', 'The Conjuring: The Devil Made Me Do It', 'Wrath of Man', 'Spiral: From the Book of Saw', 'In the Heights', 'Spirit Untamed', 'Peter Rabbit 2: The Runaway','The House Next Door','Queen Bees'],
        axisLine: {
            show: true,
         lineStyle: {
                color: "rgba(255,255,255,.1)",
    ...
    series: [{
        type: 'bar',
        data: [109.4, 56.0, 43.8, 26.0, 22.6, 11.4, 11.0, 10.4, 1.0, 0.375],
        barWidth:'35%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
